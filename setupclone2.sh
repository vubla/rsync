...
echo "Cloning..."
rsync -zaHl   --exclude=/etc/hostname --exclude=/etc/udev/rules.d/70-persistent-net.rules --exclude=/dev/*  --exclude=/proc/* --exclude=/tmp/* --exclude=/lost+found/* 11895@ch-s011.rsync.net:prime/* $1:/
echo "Done Cloning"
 ssh-keygen -f "/root/.ssh/known_hosts" -R $1
